          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 text-white rounded-md border-b outline-none"
            ...
            <button
              type="submit"
              className="w-full bg-white text-black py-2 px-4 rounded-md hover:bg-yellow-600 transition-colors duration-300 font-semibold"
            >
              Sign Up
            </button>
          </form>
